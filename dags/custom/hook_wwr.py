"""
This is a module with the WeWorkRemotely hook implementation for Apache Airflow.
"""
...
class WeWorkRemotelyHook(BaseHook):
    """
    This is the hook for accessing the WeWorkRemotely job postings.
    ...
    def get_job_offers(self):
        """
        Returns a generator for the jobs at WeWorkRemotely.

        Returns:
            feed.entries - generator with the job postings at WeWorkRemotely as a
            JSON structure
        """
        self.get_conn()
        endpoint = '/remote-jobs.rss'
